...
angular.module('app')
  .controller('AppCtrl', ['$scope', '$translate', '$localStorage', '$window', '$cookies','$cookieStore', '$interpolate', '$timeout',
    function(              $scope,   $translate,   $localStorage,   $window, $cookies,$cookieStore, $interpolate, $timeout) {
